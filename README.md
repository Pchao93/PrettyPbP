...
NOTE: As of late 2017, the NBA has chosen to restrict access to their API from the majority of server providers. Until this decision has changed, PrettyPbP may face occasional uptime outages.
...
## Features
  * Matchups
    * Users can view individual NBA games that occur on the day of their selection, , selected from an index of games, their own collections, or through search.
  ...
  * Reviews
    ...
    * In a specific game's page, user's can pair their rating with a detailed text review.
  * Search
...
## Technologies Used
 * Backend
   * Routing and Controllers: Express JS
   * Hosting and Deployment: Raspberry Pi 3
 * Frontend
